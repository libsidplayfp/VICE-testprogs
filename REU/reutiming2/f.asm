...
.endif
        ...
        .section data
reu0:   .byte %10010000 ;start c64->reu
        .word buffer    ;c64 addr
        .long 0         ;reu addr
        .word $200      ;len
        .byte 0         ;irq mask
        .byte 0         ;addr control
...
-       cmp $d012
        ...
        ; transfer the pattern from REU to buffer
        .section data
reu     .byte %10010001
        .word result
        .long 0
...
.if IOGLITCH == 0
    .if SWAP == 0
            .if TRANSFERBYTES == 19
                .binary "ref/f-ref.bin" ; ok
            .else
                .binary "ref/f2-ref.bin"    ; ok
            .endif
    .else
            .if TRANSFERBYTES == 10
                .binary "ref/f3-m2.bin"     ; gpz breadbox
            .else
                .binary "ref/f4-m2.bin"     ; gpz breadbox
            .endif
    .endif
.else
    .if SWAP == 0
            .if TRANSFERBYTES == 19
                .binary "ref/f-ref.bin"
            .else
                .binary "ref/f2-ref.bin"
            .endif
    .else
            .if TRANSFERBYTES == 10
                .binary "ref/f3-ref.bin"
            .else
                .binary "ref/f4-ref.bin"
            .endif
    .endif
.endif
