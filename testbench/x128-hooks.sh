...
X128OPTS+=" -VICIIsaturation 1000"
X128OPTS+=" -VICIIbrightness 1000"
X128OPTS+=" -VICIIcontrast 1000"
X128OPTS+=" -VICIIgamma 1000"
X128OPTS+=" -VICIItint 1000"
X128OPTS+=" -warp"
#X128OPTS+=" -console"
X128OPTS+=" -debugcart"
X128OPTS+=" -jamaction 1"
X128OPTS+=" -drive8extend 0"
X128OPTS+=" +easyflashcrtwrite"
