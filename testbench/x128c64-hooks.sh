...
X128C64OPTS+=" -VICIIsaturation 1000"
X128C64OPTS+=" -VICIIbrightness 1000"
X128C64OPTS+=" -VICIIcontrast 1000"
X128C64OPTS+=" -VICIIgamma 1000"
X128C64OPTS+=" -VICIItint 1000"
X128C64OPTS+=" -warp"
