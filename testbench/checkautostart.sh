...
dotest $EMU $PROG $OPTS -drive8truedrive +virtualdev -autostartprgmode 0 +autostart-handle-tde -autostart-warp
dotest $EMU $PROG $OPTS -drive8truedrive +virtualdev -autostartprgmode 0 +autostart-handle-tde +autostart-warp
dotest $EMU $PROG $OPTS -drive8truedrive -virtualdev -autostartprgmode 0 +autostart-handle-tde -autostart-warp
dotest $EMU $PROG $OPTS -drive8truedrive -virtualdev -autostartprgmode 0 +autostart-handle-tde +autostart-warp
dotest $EMU $PROG $OPTS +drive8truedrive +virtualdev -autostartprgmode 0 +autostart-handle-tde -autostart-warp
...
dotest $EMU $PROG $OPTS +drive8truedrive -virtualdev -autostartprgmode 0 +autostart-handle-tde -autostart-warp
dotest $EMU $PROG $OPTS +drive8truedrive -virtualdev -autostartprgmode 0 +autostart-handle-tde +autostart-warp
dotest $EMU $PROG $OPTS -drive8truedrive +virtualdev -autostartprgmode 1 +autostart-handle-tde -autostart-warp
dotest $EMU $PROG $OPTS -drive8truedrive +virtualdev -autostartprgmode 1 +autostart-handle-tde +autostart-warp
dotest $EMU $PROG $OPTS -drive8truedrive -virtualdev -autostartprgmode 1 +autostart-handle-tde -autostart-warp
dotest $EMU $PROG $OPTS -drive8truedrive -virtualdev -autostartprgmode 1 +autostart-handle-tde +autostart-warp
dotest $EMU $PROG $OPTS +drive8truedrive +virtualdev -autostartprgmode 1 +autostart-handle-tde -autostart-warp
...
dotest $EMU $PROG $OPTS +drive8truedrive -virtualdev -autostartprgmode 1 +autostart-handle-tde -autostart-warp
dotest $EMU $PROG $OPTS +drive8truedrive -virtualdev -autostartprgmode 1 +autostart-handle-tde +autostart-warp
dotest $EMU $PROG $OPTS -drive8truedrive +virtualdev -autostartprgmode 2 +autostart-handle-tde -autostart-warp
dotest $EMU $PROG $OPTS -drive8truedrive +virtualdev -autostartprgmode 2 +autostart-handle-tde +autostart-warp
dotest $EMU $PROG $OPTS -drive8truedrive -virtualdev -autostartprgmode 2 +autostart-handle-tde -autostart-warp
dotest $EMU $PROG $OPTS -drive8truedrive -virtualdev -autostartprgmode 2 +autostart-handle-tde +autostart-warp
dotest $EMU $PROG $OPTS +drive8truedrive +virtualdev -autostartprgmode 2 +autostart-handle-tde -autostart-warp
