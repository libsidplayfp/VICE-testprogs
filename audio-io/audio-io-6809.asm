...
userport_woj_input_menu:
	jsr cls
	ldx #choose_input_ports_8_menu_text
	jsr print_string

userport_woj_input_menu_choose:
	jsr wtl_getchar
	cmpb #'1'
	beq userport_woj1_input_menu
	cmpb #'2'
	beq userport_woj2_input_menu
	cmpb #'3'
	beq userport_woj3_input_menu
	cmpb #'4'
	beq userport_woj4_input_menu
	cmpb #'5'
	beq userport_woj5_input_menu_jmp
	cmpb #'6'
	beq userport_woj6_input_menu_jmp
	cmpb #'7'
	beq userport_woj7_input_menu_jmp
	cmpb #'8'
	beq userport_woj8_input_menu_jmp
	bra userport_woj_input_menu_choose

userport_woj5_input_menu_jmp:
	jmp userport_woj5_input_menu

userport_woj6_input_menu_jmp:
	jmp userport_woj6_input_menu

userport_woj7_input_menu_jmp:
	jmp userport_woj7_input_menu

userport_woj8_input_menu_jmp:
	jmp userport_woj8_input_menu

userport_woj1_input_menu:
	jsr cls
	ldx #choose_input_samplers_menu_text
	jsr print_string

userport_woj1_input_menu_choose:
	jsr wtl_getchar
	cmpb #'4'
	beq setup_userport_woj1_4bit_input_jmp
	cmpb #'2'
	beq setup_userport_woj1_2bit_input_jmp
	bra userport_woj1_input_menu_choose

setup_userport_woj1_4bit_input_jmp:
	jmp setup_userport_woj1_4bit_input

setup_userport_woj1_2bit_input_jmp:
	jmp setup_userport_woj1_2bit_input

userport_woj2_input_menu:
	jsr cls
	ldx #choose_input_samplers_menu_text
	jsr print_string

userport_woj2_input_menu_choose:
	jsr wtl_getchar
	cmpb #'4'
	beq setup_userport_woj2_4bit_input_jmp
	cmpb #'2'
	beq setup_userport_woj2_2bit_input_jmp
	bra userport_woj2_input_menu_choose

setup_userport_woj2_4bit_input_jmp:
	jmp setup_userport_woj2_4bit_input

setup_userport_woj2_2bit_input_jmp:
	jmp setup_userport_woj2_2bit_input

userport_woj3_input_menu:
	jsr cls
	ldx #choose_input_samplers_menu_text
	jsr print_string

userport_woj3_input_menu_choose:
	jsr wtl_getchar
	cmpb #'4'
	beq setup_userport_woj3_4bit_input_jmp
	cmpb #'2'
	beq setup_userport_woj3_2bit_input_jmp
	bra userport_woj3_input_menu_choose

setup_userport_woj3_4bit_input_jmp:
	jmp setup_userport_woj3_4bit_input

setup_userport_woj3_2bit_input_jmp:
	jmp setup_userport_woj3_2bit_input

userport_woj4_input_menu:
	jsr cls
	ldx #choose_input_samplers_menu_text
	jsr print_string

userport_woj4_input_menu_choose:
	jsr wtl_getchar
	cmpb #'4'
	beq setup_userport_woj4_4bit_input_jmp
	cmpb #'2'
	beq setup_userport_woj4_2bit_input_jmp
	bra userport_woj4_input_menu_choose

setup_userport_woj4_4bit_input_jmp:
	jmp setup_userport_woj4_4bit_input

setup_userport_woj4_2bit_input_jmp:
	jmp setup_userport_woj4_2bit_input

userport_woj5_input_menu:
	jsr cls
	ldx #choose_input_samplers_menu_text
	jsr print_string

userport_woj5_input_menu_choose:
	jsr wtl_getchar
	cmpb #'4'
	beq setup_userport_woj5_4bit_input_jmp
	cmpb #'2'
	beq setup_userport_woj5_2bit_input_jmp
	bra userport_woj5_input_menu_choose

setup_userport_woj5_4bit_input_jmp:
	jmp setup_userport_woj5_4bit_input

setup_userport_woj5_2bit_input_jmp:
	jmp setup_userport_woj5_2bit_input

userport_woj6_input_menu:
	jsr cls
	ldx #choose_input_samplers_menu_text
	jsr print_string

userport_woj6_input_menu_choose:
	jsr wtl_getchar
	cmpb #'4'
	beq setup_userport_woj6_4bit_input_jmp
	cmpb #'2'
	beq setup_userport_woj6_2bit_input_jmp
	bra userport_woj6_input_menu_choose

setup_userport_woj6_4bit_input_jmp:
	jmp setup_userport_woj6_4bit_input

setup_userport_woj6_2bit_input_jmp:
	jmp setup_userport_woj6_2bit_input

userport_woj7_input_menu:
	jsr cls
	ldx #choose_input_samplers_menu_text
	jsr print_string

userport_woj7_input_menu_choose:
	jsr wtl_getchar
	cmpb #'4'
	beq setup_userport_woj7_4bit_input_jmp
	cmpb #'2'
	beq setup_userport_woj7_2bit_input_jmp
	bra userport_woj7_input_menu_choose

setup_userport_woj7_4bit_input_jmp:
	jmp setup_userport_woj7_4bit_input

setup_userport_woj7_2bit_input_jmp:
	jmp setup_userport_woj7_2bit_input

userport_woj8_input_menu:
	jsr cls
	ldx #choose_input_samplers_menu_text
	jsr print_string

userport_woj8_input_menu_choose:
	jsr wtl_getchar
	cmpb #'4'
	beq setup_userport_woj8_4bit_input_jmp
	cmpb #'2'
	beq setup_userport_woj8_2bit_input_jmp
	bra userport_woj8_input_menu_choose

setup_userport_woj8_4bit_input_jmp:
	jmp setup_userport_woj8_4bit_input

setup_userport_woj8_2bit_input_jmp:
	jmp setup_userport_woj8_2bit_input

setup_userport_woj1_2bit_input:
	ldx #userport_woj1_input_init
	stx input_init_function
	ldx #userport_h2_p12_c2_input
	stx input_function
	ldx #userport_woj1_2bit_text
	stx input_text
	rts

setup_userport_woj1_4bit_input:
	ldx #userport_woj1_input_init
	stx input_init_function
	ldx #userport_h4_p14_c4_input
	stx input_function
	ldx #userport_woj1_4bit_text
	stx input_text
	rts

setup_userport_woj2_2bit_input:
	ldx #userport_woj2_input_init
	stx input_init_function
	ldx #userport_h2_p12_c2_input
	stx input_function
	ldx #userport_woj2_2bit_text
	stx input_text
	rts

setup_userport_woj2_4bit_input:
	ldx #userport_woj2_input_init
	stx input_init_function
	ldx #userport_h4_p14_c4_input
	stx input_function
	ldx #userport_woj2_4bit_text
	stx input_text
	rts

setup_userport_woj3_2bit_input:
	ldx #userport_woj3_input_init
	stx input_init_function
	ldx #userport_h2_p12_c2_input
	stx input_function
	ldx #userport_woj3_2bit_text
	stx input_text
	rts

setup_userport_woj3_4bit_input:
	ldx #userport_woj3_input_init
	stx input_init_function
	ldx #userport_h4_p14_c4_input
	stx input_function
	ldx #userport_woj3_4bit_text
	stx input_text
	rts

setup_userport_woj4_2bit_input:
	ldx #userport_woj4_input_init
	stx input_init_function
	ldx #userport_h2_p12_c2_input
	stx input_function
	ldx #userport_woj4_2bit_text
	stx input_text
	rts

setup_userport_woj4_4bit_input:
	ldx #userport_woj4_input_init
	stx input_init_function
	ldx #userport_h4_p14_c4_input
	stx input_function
	ldx #userport_woj4_4bit_text
	stx input_text
	rts

setup_userport_woj5_2bit_input:
	ldx #userport_woj5_input_init
	stx input_init_function
	ldx #userport_h2_p12_c2_input
	stx input_function
	ldx #userport_woj5_2bit_text
	stx input_text
	rts

setup_userport_woj5_4bit_input:
	ldx #userport_woj5_input_init
	stx input_init_function
	ldx #userport_h4_p14_c4_input
	stx input_function
	ldx #userport_woj5_4bit_text
	stx input_text
	rts

setup_userport_woj6_2bit_input:
	ldx #userport_woj6_input_init
	stx input_init_function
	ldx #userport_h2_p12_c2_input
	stx input_function
	ldx #userport_woj6_2bit_text
	stx input_text
	rts

setup_userport_woj6_4bit_input:
	ldx #userport_woj6_input_init
	stx input_init_function
	ldx #userport_h4_p14_c4_input
	stx input_function
	ldx #userport_woj6_4bit_text
	stx input_text
	rts

setup_userport_woj7_2bit_input:
	ldx #userport_woj7_input_init
	stx input_init_function
	ldx #userport_h2_p12_c2_input
	stx input_function
	ldx #userport_woj7_2bit_text
	stx input_text
	rts

setup_userport_woj7_4bit_input:
	ldx #userport_woj7_input_init
	stx input_init_function
	ldx #userport_h4_p14_c4_input
	stx input_function
	ldx #userport_woj7_4bit_text
	stx input_text
	rts

setup_userport_woj8_2bit_input:
	ldx #userport_woj8_input_init
	stx input_init_function
	ldx #userport_h2_p12_c2_input
	stx input_function
	ldx #userport_woj8_2bit_text
	stx input_text
	rts

setup_userport_woj8_4bit_input:
	ldx #userport_woj8_input_init
	stx input_init_function
	ldx #userport_h4_p14_c4_input
	stx input_function
	ldx #userport_woj8_4bit_text
	stx input_text
	rts
...
userport_woj2_input_init:
	ldb #$E0
	stb $e843
	ldb #$20
	jmp storex_e841

userport_woj3_input_init:
	ldb #$E0
	stb $e843
	ldb #$40
	jmp storex_e841

userport_woj4_input_init:
	ldb #$E0
	stb $e843
	ldb #$60
	jmp storex_e841

userport_woj5_input_init:
	ldb #$E0
	stb $e843
	ldb #$80
	jmp storex_e841

userport_woj6_input_init:
	ldb #$E0
	stb $e843
	ldb #$80
	jmp storex_e841

userport_woj7_input_init:
	ldb #$E0
	stb $e843
	ldb #$C0
	jmp storex_e841

userport_woj8_input_init:
	ldb #$E0
	stb $e843
	ldb #$E0
	jmp storex_e841
...
choose_input_ports_8_menu_text:
	fcc "Choose input"
	fcb $0d
	fcb $0d
	fcc "1: port 1"
...
userport_woj1_2bit_text:
	fcc "2 bit sampler on port 1 of userport WOJ joy adapter"
	fcb $0d
	fcb $00

userport_woj1_4bit_text:
	fcc "4 bit sampler on port 1 of userport WOJ joy adapter"
	fcb $0d
	fcb $00

userport_woj2_2bit_text:
	fcc "2 bit sampler on port 2 of userport WOJ joy adapter"
	fcb $0d
	fcb $00

userport_woj2_4bit_text:
	fcc "4 bit sampler on port 2 of userport WOJ joy adapter"
	fcb $0d
	fcb $00

userport_woj3_2bit_text:
	fcc "2 bit sampler on port 3 of userport WOJ joy adapter"
	fcb $0d
	fcb $00

userport_woj3_4bit_text:
	fcc "4 bit sampler on port 3 of userport WOJ joy adapter"
	fcb $0d
	fcb $00

userport_woj4_2bit_text:
	fcc "2 bit sampler on port 4 of userport WOJ joy adapter"
	fcb $0d
	fcb $00

userport_woj4_4bit_text:
	fcc "4 bit sampler on port 4 of userport WOJ joy adapter"
	fcb $0d
	fcb $00

userport_woj5_2bit_text:
	fcc "2 bit sampler on port 5 of userport WOJ joy adapter"
	fcb $0d
	fcb $00

userport_woj5_4bit_text:
	fcc "4 bit sampler on port 5 of userport WOJ joy adapter"
	fcb $0d
	fcb $00

userport_woj6_2bit_text:
	fcc "2 bit sampler on port 6 of userport WOJ joy adapter"
	fcb $0d
	fcb $00

userport_woj6_4bit_text:
	fcc "4 bit sampler on port 6 of userport WOJ joy adapter"
	fcb $0d
	fcb $00

userport_woj7_2bit_text:
	fcc "2 bit sampler on port 7 of userport WOJ joy adapter"
	fcb $0d
	fcb $00

userport_woj7_4bit_text:
	fcc "4 bit sampler on port 7 of userport WOJ joy adapter"
	fcb $0d
	fcb $00

userport_woj8_2bit_text:
	fcc "2 bit sampler on port 8 of userport WOJ joy adapter"
	fcb $0d
	fcb $00

userport_woj8_4bit_text:
	fcc "4 bit sampler on port 8 of userport WOJ joy adapter"
	fcb $0d
	fcb $00
