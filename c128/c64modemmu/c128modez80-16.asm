; This is a c128 mode z80 test to see what we get if we access $04xx through i/o using in/out when the mmu i/o bit is on,
...
;   blue   = z80 on, z80 bios present in c128 mode, we got $d4xx RAM
